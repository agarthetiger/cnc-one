/**
  ...
  CNC ONE post processor for RepRap configuration.

  $Revision: 41981 b469d519b41034f7622245f52b01f620c0e5ec7e $
  $Date: 2021-05-28 15:30:41 $

*/

description = "CNC ONE for Duet, tweaked by Agar";
vendor = "CNC ONE";
vendorUrl = "www.cnc.one";
legal = "Copyright (C) 2012-2021 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Router post Duet CNC, tweaked by Agar";
